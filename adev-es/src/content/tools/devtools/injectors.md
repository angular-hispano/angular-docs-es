## Inspecciona tus inyectores {#inspect-your-injectors}

NOTA: El Árbol de Inyectores está disponible para aplicaciones de Angular compiladas con la versión 17 o superior.

### Visualiza la jerarquía de inyectores de tu aplicación {#view-the-injector-hierarchy-of-your-application}
...
### Visualiza las rutas de resolución {#visualize-resolution-paths}
...
### Visualiza los proveedores del inyector {#view-injector-providers}
