...
| Pestañas                                      | Detalles                                                                                                                |
| :---------------------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| [Components](tools/devtools/component)    | Te permite explorar los componentes y directivas en tu aplicación y previsualizar o editar su estado.                    |
...
| [Injector Tree](tools/devtools/injectors) | Te permite visualizar la jerarquía de inyectores de entorno y de elementos.                                                      |
