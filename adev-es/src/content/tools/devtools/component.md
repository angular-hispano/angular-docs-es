...
## Depura tu aplicación {#debug-your-application}
...
### Explora la estructura de la aplicación {#explore-the-application-structure}
...
### Navegar al nodo host {#navigate-to-the-host-node}
...
### Navegar al código fuente {#navigate-to-source}
...
### Actualizar el valor de una propiedad {#update-property-value}
...
### Acceder al componente o directiva seleccionada en la consola {#access-selected-component-or-directive-in-console}
...
### Seleccionar una directiva o componente {#select-a-directive-or-component}
...
### Inspeccionar vistas diferibles {#inspect-deferrable-views}
