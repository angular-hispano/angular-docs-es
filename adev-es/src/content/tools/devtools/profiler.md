...
Lee más sobre esta característica en la sección [Importar grabación](tools/devtools/profiler#import-and-export-recordings).

## Comprende la ejecución de tu aplicación {#understand-your-applications-execution}
...
## Comprende la ejecución de componentes {#understand-component-execution}
...
## Vistas jerárquicas {#hierarchical-views}
...
## Depurar la detección de cambios y componentes `OnPush` {#debug-change-detection-and-onpush-components}
...
## Importar y exportar grabaciones {#import-and-export-recordings}
