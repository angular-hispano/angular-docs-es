...
| Bloque         | Descripción                                                                                                                                                                                                                                                                                                                                                                                    |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@placeholder` | Por defecto, los bloques defer no renderizan ningún contenido antes de ser disparados. El bloque `@placeholder` es un bloque opcional que declara contenido para mostrar antes de que el contenido diferido se cargue. Angular reemplaza el placeholder con el contenido diferido después de que la carga se completa. Aunque este bloque es opcional, el equipo de Angular recomienda incluir siempre un placeholder. [Aprende más en la documentación completa de vistas diferibles](guide/templates/defer) |
| `@loading`     | Este bloque opcional te permite declarar contenido que se mostrará durante la carga de cualquier dependencia diferida.                                                                                                                                                                                                                                                                        |
| `@error`       | Este bloque te permite declarar contenido que se muestra si la carga diferida falla.                                                                                                                                                                                                                                                                                                          |
