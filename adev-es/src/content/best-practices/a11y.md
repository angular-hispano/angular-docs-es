...
## Atributos de accesibilidad {#accessibility-attributes}
...
Usa la sintaxis de plantilla de [enlace de atributo](guide/templates/binding#binding-dynamic-properties-and-attributes) para controlar los valores de los atributos relacionados con la accesibilidad.

### Atributos y propiedades ARIA {#aria-attributes-and-properties}
...
## Componentes UI de Angular {#angular-ui-components}
...
### Aumentando elementos nativos {#augmenting-native-elements}
...
### Usando contenedores para elementos nativos {#using-containers-for-native-elements}
...
## Caso de estudio: Construyendo una barra de progreso personalizada {#case-study-building-a-custom-progress-bar}
...
### Gestión del foco después de la navegación {#focus-management-after-navigation}
...
### Identificación de enlaces activos {#active-links-identification}
