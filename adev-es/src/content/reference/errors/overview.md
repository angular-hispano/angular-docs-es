...
| Código    | Nombre                                                                                      |
| :-------- | :------------------------------------------------------------------------------------------ |
| `NG0100`  | [Expresión cambiada después de la verificación](errors/NG0100)                              |
...
| `NG0302`  | [Pipe no encontrado](errors/NG0302)                                                         |
| `NG0401`  | [Plataforma faltante](errors/NG0401)                                                        |
| `NG0403`  | [El NgModule en bootstrap no especifica qué componente inicializar](errors/NG0403)          |
| `NG0500`  | [Discordancia de nodo en hidratación](errors/NG0500)                                        |
| `NG0501`  | [Hidratación: hermanos faltantes](errors/NG0501)                                            |
| `NG0502`  | [Hidratación: nodo faltante](errors/NG0502)                                                 |
| `NG0503`  | [Hidratación: proyección de nodos DOM no compatible](errors/NG0503)                         |
| `NG0504`  | [La marca ngSkipHydration se aplica a un nodo inválido](errors/NG0504)                      |
...
| Código   | Nombre                                                           |
| :------- | :--------------------------------------------------------------- |
| `NG1001` | [Argumento no literal](errors/NG1001)                            |
| `NG2003` | [Token faltante](errors/NG2003)                                  |
| `NG2009` | [Selector de Shadow DOM inválido](errors/NG2009)                 |
| `NG3003` | [Ciclo de importación detectado](errors/NG3003)                  |
| `NG6100` | [NgModule.id establecido como module.id: anti-patrón](errors/NG6100) |
