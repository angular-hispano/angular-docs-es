...
## Aplicaciones que usan zone.js {#applications-that-use-zonejs}
...
### Ejecutar código después de que una aplicación se vuelva estable {#running-code-after-an-application-becomes-stable}
...
## Aplicaciones sin zonas (zoneless) {#zoneless-applications}
