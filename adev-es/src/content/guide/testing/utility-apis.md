...
Las clases [`TestBed`](#testbed-class-summary) y [`ComponentFixture`](#the-componentfixture) se cubren por separado.
...
## Resumen de la clase `TestBed` {#testbed-class-summary}
...
## El `ComponentFixture` {#the-componentfixture}
...
### Propiedades de `ComponentFixture` {#componentfixture-properties}
...
### Métodos de `ComponentFixture` {#componentfixture-methods}
...
```ts
// Filtrar DebugElements con una referencia #content
...
```ts
// Se pueden encontrar DebugElements por selector CSS o por directiva
