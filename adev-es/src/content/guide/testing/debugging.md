...
1.  Asegúrate de tener un proveedor de navegador instalado. Consulta [Ejecutar pruebas en un navegador](guide/testing/overview#running-tests-in-a-browser) para instrucciones de configuración.
