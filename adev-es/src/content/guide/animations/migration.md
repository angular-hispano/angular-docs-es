...
## Cómo escribir animaciones en CSS nativo {#how-to-write-animations-in-native-css}
...
## Creando animaciones reutilizables {#creating-reusable-animations}
...
#### Con el paquete de Aninaciones {#with-animations-package}
...
#### Con CSS nativo {#with-native-css}
...
### Animando estado y estilos {#animating-state-and-styles}
...
#### Con el paquete de Aninaciones {#with-animations-package-1}
...
#### Con CSS nativo {#with-native-css-1}
...
### Transiciones, tiempo y easing {#transitions-timing-and-easing}
...
### Disparando una animación {#triggering-an-animation}
...
#### Con el paquete de Aninaciones {#with-animations-package-2}
...
#### Con CSS nativo {#with-native-css-2}
...
## Transiciones y triggers {#transition-and-triggers}

### Coincidencia de estado predefinido y comodines {#predefined-state-and-wildcard-matching}
...
### Cálculo automático de propiedades con comodines {#automatic-property-calculation-with-wildcards}
...
#### Con el paquete de Animaciones {#with-animations-package-3}
...
#### Con CSS nativo {#with-native-css-3}
...
### Animar entrada y salida de una vista {#animate-entering-and-leaving-a-view}
...
#### Con el paquete de Ani {#with-animations-package-4}
...
#### Con CSS nativo {#with-native-css-4}
...
#### Con CSS nativo {#with-native-css-5}
...
### Animando incremento y decremento {#animating-increment-and-decrement}
...
#### Con el paquete de Aninaciones {#with-animations-package-5}
...
#### Con CSS nativo {#with-native-css-6}
...
### Animaciones padre / hijo {#parent--child-animations}
...
### Deshabilitando una animación o todas las animaciones {#disabling-an-animation-or-all-animations}
...
## Secuencias complejas {#complex-sequences}
...
### Dirigirse a elementos específicos {#targeting-specific-elements}
...
#### Con el paquete de Aninaciones {#with-animations-package-6}
...
#### Con CSS nativo {#with-native-css-7}
...
### Animaciones paralelas {#parallel-animations}
...
#### Con el paquete de Aninaciones {#with-animations-package-7}
...
#### Con CSS nativo {#with-native-css-8}
...
## Migrando usos de AnimationPlayer {#migrating-usages-of-animationplayer}
...
## Transiciones de ruta {#route-transitions}
