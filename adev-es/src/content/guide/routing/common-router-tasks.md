...
`withRouterConfig({paramsInheritanceStrategy: 'always'})`. Consulta [opciones de configuración del router](guide/routing/customizing-route-behavior#router-configuration-options) para obtener detalles sobre otras configuraciones disponibles.
