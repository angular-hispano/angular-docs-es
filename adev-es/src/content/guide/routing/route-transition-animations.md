...
Las animaciones de transición de ruta mejoran la experiencia del usuario proporcionando transiciones visuales suaves al navegar entre diferentes vistas en tu aplicación Angular. [Angular Router](/guide/routing) incluye soporte integrado para la API View Transitions del navegador, habilitando animaciones fluidas entre cambios de ruta en navegadores compatibles.
...
## Cómo funcionan View Transitions {#how-view-transitions-work}
...
## Cómo el Router usa view transitions {#how-the-router-uses-view-transitions}
...
1. **Completa la preparación de navegación** - Se ejecutan coincidencia de ruta, [lazy loading](/guide/routing/loading-strategies#lazily-loaded-components-and-routes), [guards](/guide/routing/route-guards) y [resolvers](/guide/routing/data-resolvers)
...
## Habilitar View Transitions en el Router {#enabling-view-transitions-in-the-router}
...
### Bootstrap standalone {#standalone-bootstrap}
...
### Bootstrap NgModule {#ngmodule-bootstrap}
...
## Personalizar transiciones con CSS {#customizing-transitions-with-css}
...
## Control avanzado de transición con onViewTransitionCreated {#advanced-transition-control-with-onviewtransitioncreated}
...
## Ejemplos del Chrome explainer adaptados a Angular {#examples-from-the-chrome-explainer-adapted-to-angular}
...
### Los elementos en transición no necesitan ser el mismo elemento DOM {#transitioning-elements-dont-need-to-be-the-same-dom-element}
...
### Animaciones personalizadas de entrada y salida {#custom-entry-and-exit-animations}
...
### Actualizaciones asíncronas del DOM y espera por contenido {#async-dom-updates-and-waiting-for-content}
...
### Manejar múltiples estilos de view transition con tipos de view transition {#handle-multiple-view-transition-styles-with-view-transition-types}
...
### Manejar múltiples estilos de view transition con un nombre de clase en la raíz de view transition (deprecado) {#handle-multiple-view-transition-styles-with-a-class-name-on-the-view-transition-root-deprecated}
...
### Transición sin congelar otras animaciones {#transitioning-without-freezing-other-animations}
...
### Animar con JavaScript {#animating-with-javascript}
